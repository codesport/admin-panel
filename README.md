...
Si te decides utilizar las funciones de flechas para definir componentes funcionales, hay que declararlas como constantes por medio de la palabra clave de `const`
   ...
   * **Consejo Pro 4:** Si se encuentra repitiendo las mismas lineas de código a lo largo y ancho de un componente padre o hijo, es avisado que estas lineas sean combinadas en un método de clase en una función. Después, llamarlo (es decir, la función o método de clase) cuando sea necesario.
